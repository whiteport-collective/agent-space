...
class DesignSpaceClient:
    ...
    def __init__(self, *, agent_id: str | None = None) -> None:
        ...
        self.url = (os.environ.get("AGENT_SPACE_URL") or os.environ.get("DESIGN_SPACE_URL", "")).rstrip("/")
        self.key = os.environ.get("AGENT_SPACE_ANON_KEY") or os.environ.get("DESIGN_SPACE_ANON_KEY", "")
        if not self.url or not self.key:
            raise DesignSpaceError("Missing AGENT_SPACE_URL/DESIGN_SPACE_URL or AGENT_SPACE_ANON_KEY/DESIGN_SPACE_ANON_KEY in .env or environment.")
