...
SUPABASE_URL = os.environ.get("AGENT_SPACE_URL") or os.environ.get("DESIGN_SPACE_URL", "")
SUPABASE_KEY = os.environ.get("AGENT_SPACE_ANON_KEY") or os.environ.get("DESIGN_SPACE_ANON_KEY", "")
