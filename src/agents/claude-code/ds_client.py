...
class DesignSpace:
    ...
    def __init__(self, url=None, key=None, agent_id=None):
        self.url = url or os.environ.get("AGENT_SPACE_URL") or os.environ.get("DESIGN_SPACE_URL", "")
        self.key = key or os.environ.get("AGENT_SPACE_ANON_KEY") or os.environ.get("DESIGN_SPACE_ANON_KEY", "")
