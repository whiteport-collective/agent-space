...
const SUPABASE_URL = process.env.AGENT_SPACE_URL || process.env.DESIGN_SPACE_URL || '';
const SUPABASE_KEY = process.env.AGENT_SPACE_ANON_KEY || process.env.DESIGN_SPACE_ANON_KEY || '';
